...
public class EntradaProcediment {
    ...
    // quants temporals (definicions) s'han eliminat per optimització
    public int nTemporalsEliminats;
    ...
    public void incrementTemporalsEliminats() { this.nTemporals--; }
    ...
    public String toFullString() {
        return String.format(
                "%3d | %-16s | params:%2d | locals:%2d | temps:%2d | label:%3d | idRet:%3d | ocupVL:%3d | ocupPM:%3d",
